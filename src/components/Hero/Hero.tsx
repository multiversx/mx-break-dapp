...
import { TrendChart } from '../TrendChart/TrendChart.tsx';

export const Hero = () => {
  return (
    <div className="relative flex w-full flex-col min-h-[calc(100vh-120px)] xl:min-h-[calc(90vh-120px)] items-center pt-10 sm:pt-20 md:pt-20 xl:pt-40 bg-[url('/src/assets/hero.png')] bg-top bg-no-repeat md:bg-[url('/src/assets/hero.png')] bg-contain">
